...
def plot_cdf(data1, data2, data3):
    ...
    plt.plot(sorted_data1, y_vals1, color = 'g', label = 'm = 1')
    plt.plot(sorted_data2, y_vals2, color = 'r', label = 'm = 5')
    plt.plot(sorted_data3, y_vals3, color = 'b', label = 'm = 10')
    plt.xlabel('Social Welfare', fontsize = 14)
    plt.ylabel('CDF', fontsize = 14)
    plt.title('CDF of Social Welfare')
    plt.grid(True)
    plt.show()

def plot_boxplot(data1, data2, data3, label):
    plt.xticks(fontsize=16)
    plt.boxplot([data1, data2, data3], labels = label, showfliers = False) #label 和 value 等长向量
    plt.ylim(0.5)
    #plt.xlabel('Category')
...
eta = 0.05
alpha = 0.8
Dynamic_Alg1 = Random_Sub_Hedge(20, 1000, 1, eta, alpha)
Dynamic_Alg2 = Random_Sub_Hedge(20, 1000, 5, eta, alpha)
Dynamic_Alg3 = Random_Sub_Hedge(20, 1000, 10, eta, alpha)
m = 500
...
for t in range(T):
    ...
    Ex_dynamic_V1.append( V_Ex_dynamic / V_best)
    ...
    Ex_dynamic_V2.append( V_Ex_dynamic / V_best)
    ...
    Ex_dynamic_V3.append(V_Ex_dynamic / V_best)
...
plot_boxplot(Ex_dynamic_V1, Ex_dynamic_V2, Ex_dynamic_V3, ['m = 1','m = 5','m = 10'])
#plot_cdf(Ex_dynamic_V1, Ex_dynamic_V2, Ex_dynamic_V3)
